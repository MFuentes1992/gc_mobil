...
if (
  isset($urlPayload["code"]) && isset($urlPayload["idRecinto"]) &&
  isset($urlPayload["titulo"]) && isset($urlPayload["descripcion"])
) {
  ...
  $headers = array(
    "Authorization: Bearer " . $accessToken . "", "content-type: application/json;UTF-8"
  );
